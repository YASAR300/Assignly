...
const VARIATIONS: VariationConfig[] = [
  {
    ...
    defaultPrompt: 'Professional jewelry commercial product shot, isolated on pure solid white studio background, clean drop shadow, sharp focus, crisp details, highly detailed jewelry photography, 8k',
  },
  {
    id: 'theme_marble',
    ...
    defaultPrompt: 'Luxury product photograph of jewelry placed on a sleek polished white carrara marble table surface, soft elegant morning side lighting, blurred depth of field background, commercial look',
  },
  {
    id: 'theme_velvet',
    ...
    defaultPrompt: 'Stunning commercial showcase of jewelry resting on rich deep royal emerald green velvet fabric with soft elegant folds, luxurious moody lighting, dramatic shadows, shallow depth of field, 8k',
  },
  {
    id: 'creative_sunset',
    ...
    defaultPrompt: 'Artistic jewelry photograph placed on a warm tropical sandy beach at sunset, glowing golden hour light, gentle waves in soft focus background, magical reflections, high fidelity presentation',
  },
  {
    id: 'creative_forest',
    ...
    defaultPrompt: 'Ethereal jewelry showcase resting on mossy natural wood in a misty sun-dappled green forest canopy, rays of light filtering through trees in soft focus, organic and natural luxury, 8k',
  },
  {
    id: 'model_front',
    ...
    defaultPrompt: 'High fashion editorial photo of a beautiful elegant female model wearing a jewelry necklace, frontal portrait shot, soft natural skin texture, expensive designer dress, luxurious studio lighting, cinematic',
    angle: 'front',
  },
  {
    id: 'model_side',
    ...
    defaultPrompt: 'Fashion magazine editorial of an elegant woman in profile, 45 degree side angle shot, showing her ear and neck wearing jewelry, soft warm sunlight, atmospheric depth, photorealistic, 8k',
    angle: 'side',
  },
  {
    id: 'model_closeup',
    ...
    defaultPrompt: 'Macro close-up studio photograph of elegant jewelry worn on the skin, extreme detail of skin pores and product facets, soft luxury cosmetics lighting, crisp focus, commercial beauty campaign',
    angle: 'closeup',
  },
]
